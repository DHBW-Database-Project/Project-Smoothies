...
WHERE c.city = 'München' AND p.product_name = 'Kiwi Smoothie';
...
WHERE d.ingredient_id = '5' OR d.ingredient_id = '6'

--6. Lists all orders made in the last seven days of January
SELECT *
FROM orders
WHERE orders_date BETWEEN DATE '2022-01-01'
AND DATE '2022-01-31'
EXCEPT
SELECT *
FROM orders
WHERE orders_date <= DATE '2022-01-25';
